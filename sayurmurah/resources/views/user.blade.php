                    ...
                    <form class="form-inline" style="margin-right: 550px; border:#317C1E ">
                        <div class="input-group">
                            ...
                            <div class="input-group-prepend" style="color: #317C1E">
                                <div class="btn btn-outline-success"> <img src="{{ asset('template/assets/img/search.svg') }}" alt=""></div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row about-container">
                    ...
                    <div class="col-lg-6 background order-lg-2" data-aos="zoom-in">
                        <img src="{{ asset('template/assets/img/about-img.svg') }}" class="img-fluid" alt="">
                    </div>
                </div>

                <div class="row about-extra">
                    <div class="col-lg-6" data-aos="fade-right">
                        <img src="{{ asset('template/assets/img/about-extra-1.svg') }}" class="img-fluid"
                            alt="">
                    </div>
                ...
                <div class="row about-extra">
                    <div class="col-lg-6 order-1 order-lg-2" data-aos="fade-left">
                        <img src="{{ asset('template/assets/img/about-extra-2.svg') }}" class="img-fluid"
                            alt="">
                    </div>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row justify-content-center">
                    ...
                    <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="200">
                        <div class="box">
                            <div class="icon"><i class="bi bi-card-checklist" style="color: #e9bf06;"></i>
                            </div>
                            <h4 class="title"><a href="">Dolor Sitema</a></h4>
                            <p class="description">Minim veniam, quis nostrud exercitation ullamco laboris nisi ut
                                aliquip ex ea commodo consequat tarad limino ata</p>
                    ...
                    <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="100">
                        <div class="box">
                            <div class="icon"><i class="bi bi-brightness-high" style="color: #d6ff22;"></i>
                            </div>
                    ...
                    <div class="col-md-6 col-lg-5" data-aos="zoom-in" data-aos-delay="200">
                        <div class="box">
                            <div class="icon"><i class="bi bi-calendar4-week" style="color: #4680ff;"></i>
                            </div>
                            <h4 class="title"><a href="">Eiusmod Tempor</a></h4>
                            <p class="description">Et harum quidem rerum facilis est et expedita distinctio. Nam
                                libero tempore, cum soluta nobis est eligendi</p>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card" data-aos="zoom-in" data-aos-delay="200">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Voluptates nihil et quis omnis et eaque omnis sint aut.
                                    Ducimus dolorum aspernatur.</p>
                                <a href="#" class="readmore">Read more </a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 mb-4">
                        <div class="card" data-aos="zoom-in" data-aos-delay="300">
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">Autem quod nesciunt eos ea aut amet laboriosam ab. Eos quis
                                    porro in non nemo ex. </p>
                                <a href="#" class="readmore">Read more </a>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('template/assets/img/portfolio/app1.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4><a href="{{ asset('template/portfolio-details.html') }}">App 1</a></h4>
                                <p>App</p>
                                <div>
                                    <a href="{{ asset('template/assets/img/portfolio/app1.jpg') }}"
                                        data-gallery="portfolioGallery" title="App 1"
                                        class="portfolio-lightbox link-preview"><i class="bi bi-plus"></i></a>
                                    <a href="{{ asset('template/portfolio-details.html') }}" class="link-details"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('template/assets/img/portfolio/web3.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4><a href="{{ asset('template/portfolio-details.html') }}">Web 3</a></h4>
                                <p>Web</p>
                                <div>
                                    <a href="{{ asset('template/assets/img/portfolio/web3.jpg') }}"
                                        class="portfolio-lightbox link-preview" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('template/assets/img/portfolio/app2.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4><a href="{{ asset('template/portfolio-details.html') }}">App 2</a></h4>
                                <p>App</p>
                                <div>
                                    <a href="{{ asset('template/assets/img/portfolio/app2.jpg') }}"
                                        class="portfolio-lightbox link-preview" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('template/assets/img/portfolio/card2.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4><a href="{{ asset('template/portfolio-details.html') }}">Card 2</a></h4>
                                <p>Card</p>
                                <div>
                                    <a href="{{ asset('template/assets/img/portfolio/card2.jpg') }}"
                                        class="portfolio-lightbox link-preview" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('template/assets/img/portfolio/web2.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4><a href="{{ asset('template/portfolio-details.html') }}">Web 2</a></h4>
                                <p>Web</p>
                                <div>
                                    <a href="{{ asset('template/img/portfolio/web2.jpg') }}"
                                        class="portfolio-lightbox link-preview" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-app">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('template/assets/img/portfolio/app3.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4><a href="portfolio-details.html">App 3</a></h4>
                                <p>App</p>
                                <div>
                                    <a href="{{ asset('template/assets/img/portfolio/app3.jpg') }}"
                                        class="portfolio-lightbox link-preview" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('template/assets/img/portfolio/card1.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4><a href="{{ asset('template/portfolio-details.html') }}">Card 1</a></h4>
                                <p>Card</p>
                                <div>
                                    <a href="{{ asset('template/assets/img/portfolio/card1.jpg') }}"
                                        class="portfolio-lightbox link-preview" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-card">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('template/assets/img/portfolio/card3.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4><a href="{{ asset('template/portfolio-details.html') }}">Card 3</a></h4>
                                <p>Card</p>
                                <div>
                                    <a href="{{ asset('template/assets/img/portfolio/card3.jpg') }}"
                                        class="portfolio-lightbox link-preview" data-gallery="portfolioGallery"
                    ...
                    <div class="col-lg-4 col-md-6 portfolio-item filter-web">
                        <div class="portfolio-wrap">
                            <img src="{{ asset('template/assets/img/portfolio/web1.jpg') }}" class="img-fluid"
                                alt="">
                            <div class="portfolio-info">
                                <h4><a href="{{ asset('template/portfolio-details.html') }}">Web 1</a></h4>
                                <p>Web</p>
                                <div>
                                    <a href="{{ asset('template/assets/img/portfolio/web1.jpg') }}"
                                        class="portfolio-lightbox link-preview" data-gallery="portfolioGallery"
                            ...
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="{{ asset('template/assets/img/testimonial-1.jpg') }}"
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="{{ asset('template/assets/img/testimonial-2.jpg') }}"
                                            class="testimonial-img" alt="">
                                        <h3>Sara Wilsson</h3>
                                        <h4>Designer</h4>
                                        <p>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="{{ asset('template/assets/img/testimonial-3.jpg') }}"
                                            class="testimonial-img" alt="">
                                        <h3>Jena Karlis</h3>
                                        <h4>Store Owner</h4>
                                        <p>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="{{ asset('template/assets/img/testimonial-4.jpg') }}"
                                            class="testimonial-img" alt="">
                                        <h3>Matt Brandon</h3>
                                        <h4>Freelancer</h4>
                                        <p>
                                ...
                                <div class="swiper-slide">
                                    <div class="testimonial-item">
                                        <img src="{{ asset('template/assets/img/testimonial-5.jpg') }}"
                                            class="testimonial-img" alt="">
                                        <h3>John Larson</h3>
                                        <h4>Entrepreneur</h4>
                                        <p>
            ...
            <div class="container" data-aos="fade-up">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-delay="200">
                        <div class="member">
                            <img src="{{ asset('template/assets/img/team-2.jpg') }}" class="img-fluid" alt="">
                            <div class="member-info">
                                <div class="member-info-content">
                                    <h4>Sarah Jhonson</h4>
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-delay="300">
                        <div class="member">
                            <img src="{{ asset('template/assets/img/team-3.jpg') }}" class="img-fluid" alt="">
                            <div class="member-info">
                                <div class="member-info-content">
                    ...
                    <div class="col-lg-3 col-md-6" data-aos="zoom-out" data-aos-delay="400">
                        <div class="member">
                            <img src="{{ asset('template/assets/img/team-4.jpg') }}" class="img-fluid" alt="">
                            <div class="member-info">
                                <div class="member-info-content">
                                    <h4>Amanda Jepson</h4>
                ...
                <div class="row g-0 clients-wrap clearfix" data-aos="zoom-in" data-aos-delay="100">
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="{{ asset('template/assets/img/clients/client-1.png') }}"
                                class="img-fluid" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="{{ asset('template/assets/img/clients/client-2.png') }}"
                                class="img-fluid" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="{{ asset('template/assets/img/clients/client-3.png') }}"
                                class="img-fluid" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="{{ asset('template/assets/img/clients/client-4.png') }}"
                                class="img-fluid" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="{{ asset('template/assets/img/clients/client-5.png') }}"
                                class="img-fluid" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="{{ asset('template/assets/img/clients/client-6.png') }}"
                                class="img-fluid" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="{{ asset('template/assets/img/clients/client-7.png') }}"
                                class="img-fluid" alt="">
                        </div>
                    </div>
                    ...
                    <div class="col-lg-3 col-md-4 col-xs-6">
                        <div class="client-logo">
                            <img src="{{ asset('template/assets/img/clients/client-8.png') }}"
                                class="img-fluid" alt="">
                        </div>
                    </div>
