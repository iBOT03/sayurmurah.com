<!DOCTYPE html>
  <html lang="en">
    <head>
      ...
      <link href="style/assets/css/bootstrap/bootstrap.min.css" rel="stylesheet">
          ...
          <form style="margin-top: 1.5rem" action="" method="post">
            <div style="margin-bottom: 1.75rem">
              ...
              <div class="d-flex w-100 div-input">
                <input class="input-field border-0" type="name" name="" id="" placeholder="Masukkan Nama Lengkap"
            ...
            <div style="margin-bottom: 1.75rem">
              ...
              <div class="d-flex w-100 div-input">
                <input class="input-field border-0" type="name" name="" id="" placeholder="Masukkan Username"
                  autocomplete="on" required />
              </div>
            </div>
            <div style="margin-bottom: 1.75rem">
              ...
              <div class="d-flex w-100 div-input">
                <input class="input-field border-0" type="name" name="" id="" placeholder="Masukkan Email"
                  autocomplete="on" required />
              </div>
            </div>
    ...
    <script>
      ...
      <script src="style/assets/vendor/bootstrap/dist/js/bootstrap.bundle.min.js"></script>
    </body>
  </html>